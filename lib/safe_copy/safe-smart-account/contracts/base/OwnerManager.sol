 ...
 */
abstract contract OwnerManager is SelfAuthorized, Test {
    ...
    function setupOwners(address[] memory _owners, uint256 _threshold) internal {
        ...
        vm.assume (_owners.length == 1);
        vm.assume (_owners[0] == address(0xcafe0003));
        ...
        /*console.log("before getOwners");
        address[] memory add_owners = this.getOwners();
        console.log("after getOwners");
        console.log(add_owners.length);
        address walletOwner;
        unchecked {
            walletOwner = add_owners[0];
        }
        console.log("check walletOwner is");
